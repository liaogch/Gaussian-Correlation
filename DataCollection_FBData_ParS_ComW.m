function [ U_g_ave,Ind_TotUti_ave,Num_reporter_ave,Rep_AveUti_ave,sigma_g_ave ] = DataCollection_FBData_ParS_ComW( filename, M_min,mu_w,sigma_w,lower_w,upper_w,p_w,mu_s,sigma_s,ind_sigma,lower_s,upper_s,selfS,p_s,R_d,r_d,R_g,r_a,r_g,iteration_times )
%DATACOLLECTION_FBDATA_PARS_COMW 此处显示有关此函数的摘要
%   此处显示详细说明
