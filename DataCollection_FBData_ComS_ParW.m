function [ U_g_ave,Ind_TotUti_ave,Num_reporter_ave,Rep_AveUti_ave,sigma_g_ave ] = DataCollection_FBData_ComS_ParW(  filename, M_min,mu_w,sigma_w,lower_w,upper_w,p_w,mu_s,sigma_s,ind_sigma,lower_s,upper_s,selfS,p_s,R_d,r_d,R_g,r_a,r_g,iteration_times )
%DATACOLLECTION_FBDATA_COMS_PARW 此处显示有关此函数的摘要
%   此处显示详细说明
...
parfor i = 1:iteration_times
    ...
    [ Con_M, ~, Num_reporter(i),sigma_g(i) ] = ReporterSelection( R_g,r_g,T,S,M_min,Con_cor_var,r_d,r_a);
